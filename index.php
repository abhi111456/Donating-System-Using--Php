...
<body>
    <div id="full">
        ...
        <div id="inner-class" align="center">
           <div id="header" style="background-color:black; color:white;"><h2> Money Donation System</h2>
           <marquee style="background-color:black; color:white; font-size:25px;">you can donate the money for the poor people
            ...
            <div id="body">
                ...
                <table align="center">
                    <tr>
                        <td width="200px" height="80px" style="font-size:20px;"><b>Enter username</b></td>
                        <td width="100px" height="40px"><input type="text" name="un" placeholder="enter username"
                        style="width:180px; height:40px;border-radius:10px;"></td>
                    </tr>
                    <tr>
                        <td width="200px" height="80px" style="font-size:20px;"><b>Enter password</b></td>
                        <td width="200px" height="40px"><input type="text" name="ps" placeholder="enter password"
                        style="width:180px; height:40px;border-radius:10px;"></td>
                    </tr>
                    <tr>
                        <td><input type="submit" name="sub" value="login"
                        style="width:70px; height:40px;border-radius:5px;"></td>
                    </tr>
                </table>
           </form>
           <?php
